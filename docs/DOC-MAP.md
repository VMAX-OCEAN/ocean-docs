...
| 01 | `research/` | benchmarks, teardowns, techniques | google-earth, nullschool, platform-comparison, open-source-projects, temperature-rendering |
| 02 | `architecture/` | stack + system + backend + code layout | system-architecture, tech-stack, `TECH-STACK-SUMMARY.md`, backend-strategy, project-structure |
